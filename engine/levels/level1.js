...
Level1.prototype.setup = function(camera) {
    ...
    this.enemies[6 * this.mapWidth + 19] = new BeetleEnemy(19, 6, Config.tileSize, Config.tileSize, BeetleEnemy.HORIZONTAL, 100, Config.tileSize * 7, this.camera);
    ...
    this.enemies[8 * this.mapWidth + 68] = new FlyDemonEnemy(68, 8, Config.tileSize * 1.2, Config.tileSize * 1.2, 300, 50, 3, Config.tileSize * 15, this.camera);
    this.enemies[13 * this.mapWidth + 103] = new FlyDemonEnemy(103, 13, Config.tileSize, Config.tileSize, 200, 30, 3, Config.tileSize * 8, this.camera);
    this.enemies[10 * this.mapWidth + 118] = new FlyDemonEnemy(118, 10, Config.tileSize * 1.5, Config.tileSize * 1.5, 150, Config.tileSize, 6, Config.tileSize * 8, this.camera);
    this.enemies[11 * this.mapWidth + 149] = new BeetleEnemy(149, 11, Config.tileSize, Config.tileSize, BeetleEnemy.HORIZONTAL, 100, Config.tileSize * 13, this.camera);
    this.enemies[11 * this.mapWidth + 150] = new BeetleEnemy(150, 11, Config.tileSize, Config.tileSize, BeetleEnemy.HORIZONTAL, 200, Config.tileSize * 10, this.camera);
    ...
    this.enemies[13 * this.mapWidth + 269] = new ZombieEnemy(269, 13, Config.tileSize * 1.2, Config.tileSize * 1.2, 50, Config.tileSize, 5, this.camera);
    this.enemies[13 * this.mapWidth + 273] = new ZombieEnemy(273, 13, Config.tileSize * 1.2, Config.tileSize * 1.2, 50, Config.tileSize, 5, this.camera);
