...
Tile.TYPE[40] = {asset: "set2_black_brick1", type: Tile.WALL_TYPE};
Tile.TYPE[41] = {asset: "set2_black_brick2", type: Tile.WALL_TYPE};
Tile.TYPE[42] = {asset: "set2_black_brick3", type: Tile.WALL_TYPE};
...
Tile.TYPE[57] = {asset: "set2_door1", type: Tile.TEXTURE};
Tile.TYPE[58] = {asset: "set2_door2", type: Tile.TEXTURE};
Tile.TYPE[59] = {asset: "set2_door3", type: Tile.TEXTURE};
Tile.TYPE[60] = {asset: "set2_door4", type: Tile.TEXTURE};
...
Tile.TYPE[67] = {asset: "set2_goldenblock", type: Tile.PLATFORM_TYPE};
Tile.TYPE[68] = {asset: "set2_goldenblock_left", type: Tile.PLATFORM_TYPE};
Tile.TYPE[69] = {asset: "set2_line_bottom", type: Tile.LADDER_TYPE};
Tile.TYPE[70] = {asset: "set2_line_top", type: Tile.LADDER_TOP_TYPE};
