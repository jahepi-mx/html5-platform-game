...
FlyDemonBossEnemy.prototype.shoot = function(x, y, blasts) {
    if (this.isShooting) {
        ...
        if (this.shootType === 1) {
            ...
            blasts.push(new EnemyBlast(this, radians, 0.3, EnemyBlast.SPHERE_TYPE, false, this.camera));
        } else {
            this.shootType = 1;
            blasts.push(new EnemyBlast(this, Math.PI / 180 * -45, 0.3, EnemyBlast.SPHERE_TYPE, false, this.camera));
            blasts.push(new EnemyBlast(this, Math.PI / 180 * -90, 0.3, EnemyBlast.SPHERE_TYPE, false, this.camera));
            blasts.push(new EnemyBlast(this, Math.PI / 180 * -135, 0.3, EnemyBlast.SPHERE_TYPE, false, this.camera));
